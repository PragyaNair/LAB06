...
def get_expected_sha256():
    ...
    text = response.text
    sha256_start_index = text.find('SHA-256: ') + len('SHA-256: ')
    sha256_end_index = text.find('</p>', sha256_start_index)
    expected_sha256 = text[sha256_start_index:sha256_end_index].strip()
